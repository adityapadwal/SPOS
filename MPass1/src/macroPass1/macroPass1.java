...
BufferedReader br1=new BufferedReader(new FileReader("C:/Users/Aditya Padwal/Desktop/macroPass1/src/input.txt"));
String line;
mdt[] MDT=new mdt[20];
mnt[] MNT=new mnt[4];
...
br1.close();
BufferedWriter bw1=new BufferedWriter(new FileWriter("C:/Users/Aditya Padwal/Desktop/macroPass1/src/macroPass1/mnt.txt"));
System.out.println("\n\t********MACRO NAME TABLE**********");
System.out.println("\n\tINDEX\tNAME\tADDRESS");
...
bw1.close();
bw1=new BufferedWriter(new FileWriter("C:/Users/Aditya Padwal/Desktop/macroPass1/src/macroPass1/arglist.txt"));
System.out.println("\n\n\t********ARGUMENT LIST**********");
System.out.println("\n\tINDEX\tNAME\tADDRESS");
...
System.out.println("\n\tINDEX\t\tSTATEMENT");
bw1=new BufferedWriter(new FileWriter("C:/Users/Aditya Padwal/Desktop/macroPass1/src/macroPass1/mdt.txt"));
