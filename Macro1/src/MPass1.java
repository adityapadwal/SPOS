...
public class MPass1 {
	public static void main(String[] args) throws IOException {
		...
		BufferedReader br1=new BufferedReader(new FileReader("/home/ubuntu/eclipse-workspace/Macro1/bin/input3.txt"));
	 	String line;
	 	mdt[] MDT=new mdt[20];
	 	mnt[] MNT=new mnt[4];
	 	...
	 	BufferedWriter bw1=new BufferedWriter(new FileWriter("/home/ubuntu/eclipse-workspace/Macro1/bin/MNT.txt"));
	 	System.out.println("\n\t********MACRO NAME TABLE**********");
		System.out.println("\n\tINDEX\tNAME\tADDRESS");
		...
		bw1=new BufferedWriter(new FileWriter("/home/ubuntu/eclipse-workspace/Macro1/bin/ARGLIST.txt"));
		System.out.println("\n\n\t********ARGUMENT LIST**********");
		System.out.println("\n\tINDEX\tNAME\tADDRESS");
		...
		bw1=new BufferedWriter(new FileWriter("/home/ubuntu/eclipse-workspace/Macro1/bin/MDT.txt"));
